...
Ans. One of the most important things under GST will be timely uploading of the details of outward supplies in Form GSTR-1 by 10th of next month. How best this can be ensured will depend on the number of B2B invoices that the taxpayer issues. If the number is small, the taxpayer can upload all the
...
## Q2. When can a taxable person pay tax on a provisional basis?
...
(b) DirecttheconductofaspecialauditunderSection 66 which is to be conducted by a Chartered Accountant or a Cost Accountant nominated for this purpose by the Commissioner; or
...
(a) Audit by Chartered Accountant or a Cost Accountant: Every registered person whose turnover exceeds the prescribed limit, shall get his accounts audited by a
...
Ans. The Assistant / Deputy Commissioner is to serve the communication for special audit only after prior
...
Ans. The refund arising out of existing law will be paid as per the provisions of the existing law and will be made in
...
Ans. Yes. In terms of Section 16 of the IGST Act, a registered taxable person shall have the option either to

## Page 124

export goods/services without payment of IGST under bond or letter of undertaking and claim refund of ITC or he can export goods/services on payment of IGST and claim refund of IGST paid.
...
(ii) In case of section 74(cases of fraud/suppression of facts/willful misstatement), the time limit for adjudication is 5 years from the due date for filing of annual return for the financial year to which demand relates to. $\{$ sec.74(10)\}

Q 6. Is there any immunity to a person chargeable with tax in cases of fraud/suppression of facts/

## Page 129

willful misstatement, who pays the amount of demand along-with interest before issue of notice?
...
Ans. Where the business in respect of which any tax is payable is carried on by any guardian / trustee / agent of a minor or other incapacitated person on behalf of and for the
...
Ans. For the aggrieved person, the time limit is fixed as 3 months from the date of communication of order or decision. For the department (Revenue), the time limit is 6 months within which review proceedings have to be completed and appeal filed before the $A A$
...
## Q 9. Whether in an appeal the AA can pass an order enhancing the quantum of duty/ fine/ penalty/

## Page 137

reduce the amount of refund/ITC from the one passed by the original authority?
...
If the applicant is aggrieved with the finding of the AAR, he can file an appeal with AAAR. Similarly, if the concerned

## Page 147

or jurisdictional officer of CGST/SGST/UTGST does not agree with the finding of AAR, he can also file an appeal with AAAR. The word concerned officer of CGST/SGST means an officer who has been designated by the CGST/SGST administration in regard to an application for advance ruling. In normal circumstances, the concerned officer will be the officer in whose jurisdiction the applicant is located. In such cases the concerned officer will be the jurisdictional CGST/SGST officer.
...
(iii) supplies any go o ds liable to tax under this Act without having applied for the registration;
...
Ans. An officer carrying out a search has the power to search for and seize goods (which are liable to confiscation) and documents, books or things (relevant for any proceedings
...
Ans. The term 'seizure' has not been specifically defined in the Model GST Law. In Law Lexicon Dictionary, 'seizure' is defined as the act of taking possession of property by an officer under legal process. It generally implies taking
...
CGST/SGST Act in respect of the power of search or seizure. These are as follows:
...
offence, he must be informed in writing of the grounds of arrest and he must be produced before a magistrate within 24 hours of his arrest;
...
of West Bengal reported in 1997 (1) SCC 416, the Hon'ble Supreme Court has laid down specific guidelines required to be followed while making arrests. While this is in relation to police, it needs to be followed by all departments having power of arrest. These are as under:
...
x. A police control room should be provided at all district and State headquarters where information regarding the arrest and the place
...
Ans. The Central Board of Excise and Customs (CBEC) in the Department of Revenue, Ministry of Finance has issued guidelines from time to time to ensure that summons provisions are not misused in the

## Page 166

field. Some of the important highlights of these guidelines are given below:
...
Ans. Section 73 of the CGST/SGST Act codifies the major offences under the Act which warrant institution of criminal proceedings and prosecution. 12 such major
...
a. Maintenance of uninterrupted ITC chain on interState transactions;
...
- $\quad$ Centre and the exporting state: The exporting state shall pay the amount equal to the ITC of SGST used by the supplier in the exporting state to the Centre.

## Page 186

- $\quad$ Centre and the importing state: The Centre shall pay the amount equal to the ITC of IGST used by a dealer for payment of SGST on intra- state supplies.
...
professionally and independently. EG also recommended a non-government company as that will have operational freedom.

These recommendations were presented before the Empowered Committee of State Finance Ministers in its $3^{\text {rd }}$ meeting of 2011 held on $19^{\text {th }}$ August 2011 and in the $4^{\text {th }}$ meeting of 2011 of the EC held on $14^{\text {th }}$ Oct 2011. The proposal of the EG on IT infrastructure for GST regarding GSTN and formation of a not-for-profit section 25 company with the strategic control of the Government were approved by the Empowered Committee of State Finance Ministers (EC) in its meeting held on14.10.11.
...
iii. The Board of Directors of GSTN SPV would comprise 14 Directors with 3 Directors from the Centre, 3 from the States, a Chairman of the

## Page 200

Board of Directors appointed through a joint approval mechanism of Centre and States, 3 Directors from private equity stake holders, 3 independent Directors who would be persons of eminence and a CEO of the GSTN SPV selected through an open selection process.
...
(f) Computation of settlement (including IGST Settlement) between the Centre and St a t es ; Clearing house for IGST;
...
Ans. In GST regime, while taxpayer facing core services of applying for registration, uploading of invoices, filing of return, making tax payments shall be hosted by GST System, all the statutory functions (such as approval of registration, assessment of return, conducting investigation and audit
...
Ans. GSTN has engaged M/S Infosys as a single Managed Service Provider (MSP) for the design, development and deployment of GST system, including all application software, tools and Infrastructure and for operating \&
...
iii. Tax payment by creation of Challan a nd integration with agency Banks;
...
shop for all requirements under GST for the taxpayers. Illustrative list of functions that can be performed by taxpayers through GST Portal managed by GSTN are:
...
Q 20. Will GSTN provide separate user ID and password for GSTPractitioner to enable them to work on behalf of their customers (Taxpayers) without requiring user ID and password of taxpayers, as happens today?
...
GSTN has issued Provisional IDs and passwords to all such taxpayers and the same has been shared with tax authorities for conveying the same to the taxpayers. Enrolment of existing taxpayers for GST started at GST portal on $8^{\text {th }}$ November 2016 and by end of March 2017 a large number of them have activated the Provisional ID and many have completed the migration process. More details are available at https://www.gst.gov.in/help
...
So much of the said credit as is attributable to any claim related to section 3, sub-section (3) of section 5, section 6, section 6A or sub-section (8) of section 8 of

## Page 214

the Central Sales Tax Act, 1956 that is not substantiated in the manner, and within the period, prescribed in rule 12 of the Central Sales Tax (Registration and Turnover) Rules, 1957 shall not be eligible to be credited to the electronic credit ledger:
...
Ans. A manufacturer having a turnover of say Rs 60 lakh who is enjoying SSI exemption under the existing law will have to be registered under GST as the said turnover exceeds the basic threshold of Rs 20 lakh - section 22.
...
Q 10. Shall a manufacturer or a job worker become liable to pay tax if the inputs or semi-finished goods sent for job work under the existing law are returned after completion of job work after the appointed day?
...
Ans. The taxable person may issue the debit/credit note(s) or a supplementary invoice within 30 days of the price
...
goods/services under GST to the extent the tax is leviable under the existing law - section 142(11).

Q 23. In pursuance of any assessment or adjudication proceedings instituted, after the appointed day, under the existing law, an amount of tax, interest, fine or penalty becomes refundable. Shall such amount be refundable under the GST law?
